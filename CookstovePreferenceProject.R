# This code is for a PhD dissertation client project 'Best Worst Scaling Data Analysis of Cookstove Preferences in Zambia'.
# Include counting analysis and statistical comparisons
# raw data will not be provided here
